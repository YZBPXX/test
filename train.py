...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        default='/data/storage1/nas/bo.zhu/checkpoints/diffusion/sd-model-0206-text-arcface-local-arrow-jpg-center-mask-face/1_5000/',  # center cropped face
    ...
    parser.add_argument(
        "--train_batch_size", type=int, default=7, help="Batch size (per device) for the training dataloader."
    )
...
if __name__ == "__main__":
    ...
    # cd /data/storage1/public/bo.zhu/projects/train_unet && nohup bash run.sh train.py >> logs/mse.log 2>&1
